...
/** @type {string} */
const CACHE_VERSION = '1765580124|57073052';
/** @type {string} */
const CACHE_PREFIX = 'marblerun-sw-cache-';
const CACHE_NAME = CACHE_PREFIX + CACHE_VERSION;
/** @type {string} */
const OFFLINE_URL = 'marbletracks.offline.html';
/** @type {boolean} */
const ENSURE_CROSSORIGIN_ISOLATION_HEADERS = true;
// Files that will be cached on load.
/** @type {string[]} */
const CACHED_FILES = ["marbletracks.html","marbletracks.js","marbletracks.offline.html","marbletracks.icon.png","marbletracks.apple-touch-icon.png","marbletracks.audio.worklet.js","marbletracks.audio.position.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHEABLE_FILES = ["marbletracks.wasm","marbletracks.pck"];
